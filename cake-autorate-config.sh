...
achieved_rate_adjust_down_bufferbloat=0.8 # how rapidly to reduce achieved rate upon detection of bufferbloat 
shaper_rate_adjust_down_bufferbloat=0.8   # how rapidly to reduce shaper rate upon detection of bufferbloat 
...
bufferbloat_refractory_period_ms=200 # (milliseconds)
